"""Runtime kernel that wires session modules to device services."""
...
from .device.context import DeviceContext, bootstrap_device_context
...
class SessionModule(Protocol):
    """Protocol implemented by runtime session modules."""
    ...
    def handle_event(
        ...
        """Handle ``event`` routed from :meth:`SessionKernel.step`."""
