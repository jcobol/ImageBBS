...
- `python -m imagebbs.ml_extra_dump_macros --slot "$29"` surfaces the 22-byte prompt payload at `$0000`, decoded text `"COMMAND (Q TO EXIT):"`, and SHA-256 digest `ff429b988d00e0cadc5fadedb482816f4cee1805686aae0669a6e8a7630c8621`, matching the historical runtime behaviour.【a2397c†L1-L1】
