...
- Running the helper highlights the delta between the recovered macro payloads and the removed placeholders while noting that the twelve ampersand slots (and the mirrored file-transfer trio that raises the total to fifteen) remain null-terminated and ready for host consumption.【853914†L1-L18】【F:scripts/prototypes/ml_extra_defaults.py†L25-L105】
